        ...
        return [
            [
                [
                    ...
                    "paddingTop"              => DesignBlockModel::MIN_PADDING_VALUE - 1,
                    "paddingRight"            => DesignBlockModel::MIN_PADDING_VALUE - 1,
                    "paddingBottom"           => DesignBlockModel::MIN_PADDING_VALUE - 1,
                    "paddingLeft"             => DesignBlockModel::MIN_PADDING_VALUE - 1,
                    "backgroundColorFrom"     => "#ccc",
                    "backgroundColorTo"       => "#cccccc",
                    "gradientDirection"       => 99,
                    "borderTopWidth"          => DesignBlockModel::MIN_BORDER_WIDTH_VALUE - 1,
                    "borderTopLeftRadius"     => DesignBlockModel::MIN_BORDER_RADIUS_VALUE - 1,
                    "borderRightWidth"        => DesignBlockModel::MIN_BORDER_WIDTH_VALUE - 1,
                    "borderTopRightRadius"    => DesignBlockModel::MIN_BORDER_RADIUS_VALUE - 1,
                    "borderBottomWidth"       => DesignBlockModel::MIN_BORDER_WIDTH_VALUE - 1,
                    "borderBottomRightRadius" => DesignBlockModel::MIN_BORDER_RADIUS_VALUE - 1,
                    "borderLeftWidth"         => DesignBlockModel::MIN_BORDER_WIDTH_VALUE - 1,
                    "borderBottomLeftRadius"  => DesignBlockModel::MIN_BORDER_RADIUS_VALUE - 1,
                ...
                [
                    ...
                    "paddingTop"              => DesignBlockModel::MIN_PADDING_VALUE,
                    "paddingRight"            => DesignBlockModel::MIN_PADDING_VALUE,
                    "paddingBottom"           => DesignBlockModel::MIN_PADDING_VALUE,
                    "paddingLeft"             => DesignBlockModel::MIN_PADDING_VALUE,
                    "backgroundColorFrom"     => "",
                    "backgroundColorTo"       => "",
                    "gradientDirection"       => DesignBlockModel::GRADIENT_DIRECTION_HORIZONTAL,
                    "borderTopWidth"          => DesignBlockModel::MIN_BORDER_WIDTH_VALUE,
                    "borderTopLeftRadius"     => DesignBlockModel::MIN_BORDER_RADIUS_VALUE,
                    "borderRightWidth"        => DesignBlockModel::MIN_BORDER_WIDTH_VALUE,
                    "borderTopRightRadius"    => DesignBlockModel::MIN_BORDER_RADIUS_VALUE,
                    "borderBottomWidth"       => DesignBlockModel::MIN_BORDER_WIDTH_VALUE,
                    "borderBottomRightRadius" => DesignBlockModel::MIN_BORDER_RADIUS_VALUE,
                    "borderLeftWidth"         => DesignBlockModel::MIN_BORDER_WIDTH_VALUE,
                    "borderBottomLeftRadius"  => DesignBlockModel::MIN_BORDER_RADIUS_VALUE,
                    "borderColor"             => "",
