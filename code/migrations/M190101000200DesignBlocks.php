 ...
 */
class M190101000200DesignBlocks extends AbstractMigration
{
    ...
    protected function up()
    {
        $this->createTable(
            ...
            [
                ...
                'imageInstanceId'              => self::TYPE_FK_NULL,
                'backgroundPosition'           => self::TYPE_TINYINT_UNSIGNED,
                'backgroundRepeat'             => self::TYPE_TINYINT_UNSIGNED,
                'isBackgroundCover'            => self::TYPE_BOOL,
