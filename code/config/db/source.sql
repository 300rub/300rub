...
CREATE TABLE `imageInstances` (
  ...
  `flip` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `thumbX1` smallint(5) unsigned NOT NULL DEFAULT '0',
  `thumbY1` smallint(5) unsigned NOT NULL DEFAULT '0',
  `thumbX2` smallint(5) unsigned NOT NULL DEFAULT '0',
  `thumbY2` smallint(5) unsigned NOT NULL DEFAULT '0',
...
INSERT INTO `migrations` VALUES (1,'M160302000005Blocks',''),(2,'M160302000010DesignBlocks',''),(3,'M160302000020DesignTexts',''),(4,'M160303000000Seo',''),(5,'M160305000000Sections',''),(6,'M160307000000Users',''),(7,'M160308000000Files',''),(8,'M160309000000Texts',''),(9,'M160311000000Grids',''),(10,'M160317000000Images',''),(11,'M160317001000Forms',''),(12,'M160321000000Feedback',''),(13,'M160321000100Records',''),(14,'M160321000200Menu',''),(15,'M160321000300SiteMaps',''),(16,'M160321000400Search',''),(17,'M160321000500Fields',''),(18,'M160321000550Tabs',''),(19,'M160321000700Catalogs',''),(20,'M160321000800Settings','DROP TABLE IF EXISTS settings;');
...
-- Dump completed on 2018-11-16 21:44:46
