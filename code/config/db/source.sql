...
CREATE TABLE `images` (
  ...
  `type` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `viewAutoCropType` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `viewCropX` smallint(5) unsigned NOT NULL DEFAULT '0',
  `viewCropY` smallint(5) unsigned NOT NULL DEFAULT '0',
...
INSERT INTO `migrations` VALUES (1,'M190101000100Blocks','DROP TABLE IF EXISTS blocks;'),(2,'M190101000200DesignBlocks','DROP TABLE IF EXISTS designBlocks;'),(3,'M190101000300DesignTexts','DROP TABLE IF EXISTS designTexts;'),(4,'M190101000400Seo','DROP TABLE IF EXISTS seo;'),(5,'M190101000500Sections','DROP TABLE IF EXISTS sections;'),(6,'M190101000600Users','DROP TABLE IF EXISTS userEvents; DROP TABLE IF EXISTS userSettingsOperations; DROP TABLE IF EXISTS userSectionGroupOperations; DROP TABLE IF EXISTS userSectionOperations; DROP TABLE IF EXISTS userBlockGroupOperations; DROP TABLE IF EXISTS userBlockOperations; DROP TABLE IF EXISTS userSessions; DROP TABLE IF EXISTS users;'),(7,'M190101000700Files','DROP TABLE IF EXISTS files;'),(8,'M190101000800Texts','DROP TABLE IF EXISTS textInstanceFileMap; DROP TABLE IF EXISTS textInstances; DROP TABLE IF EXISTS texts;'),(9,'M190101000900Grids','DROP TABLE IF EXISTS grids; DROP TABLE IF EXISTS gridLines;'),(10,'M190101001000Images','ALTER TABLE designBlocks DROP FOREIGN KEY designBlocks_imageInstanceId_fk; DROP TABLE IF EXISTS imageInstances; DROP TABLE IF EXISTS imageGroups; DROP TABLE IF EXISTS images; DROP TABLE IF EXISTS designImageSliders; DROP TABLE IF EXISTS designImageZooms; DROP TABLE IF EXISTS designImageSimple; DROP TABLE IF EXISTS designImageAlbums;'),(11,'M190101001100Forms','DROP TABLE IF EXISTS formListValues; DROP TABLE IF EXISTS formInstances; DROP TABLE IF EXISTS forms; DROP TABLE IF EXISTS designForms;'),(12,'M190101001200Feedback','DROP TABLE IF EXISTS feedback;'),(13,'M190101001300Records','DROP TABLE IF EXISTS recordInstances; DROP TABLE IF EXISTS recordClones; DROP TABLE IF EXISTS designRecordClones; DROP TABLE IF EXISTS records; DROP TABLE IF EXISTS designRecords;'),(14,'M190101001400Menu','DROP TABLE IF EXISTS menuInstances; DROP TABLE IF EXISTS menu; DROP TABLE IF EXISTS designMenu;'),(15,'M190101001500SiteMaps','DROP TABLE IF EXISTS siteMaps;'),(16,'M190101001600Search','DROP TABLE IF EXISTS searchQueries; DROP TABLE IF EXISTS search; DROP TABLE IF EXISTS designSearch;'),(17,'M190101001700Fields','DROP TABLE IF EXISTS fieldListValues; DROP TABLE IF EXISTS fieldInstances; DROP TABLE IF EXISTS fieldGroups; DROP TABLE IF EXISTS fieldTemplates; DROP TABLE IF EXISTS fields; DROP TABLE IF EXISTS designFields;'),(18,'M190101001800Tabs','DROP TABLE IF EXISTS tabInstances; DROP TABLE IF EXISTS tabGroups; DROP TABLE IF EXISTS tabTemplates; DROP TABLE IF EXISTS tabs; DROP TABLE IF EXISTS designTabs;'),(19,'M190101001900Catalogs','DROP TABLE IF EXISTS catalogOrders; DROP TABLE IF EXISTS catalogBins; DROP TABLE IF EXISTS catalogInstanceLinks; DROP TABLE IF EXISTS catalogInstances; DROP TABLE IF EXISTS catalogMenu; DROP TABLE IF EXISTS catalogs; DROP TABLE IF EXISTS designCatalogs;'),(20,'M190101002000Settings','DROP TABLE IF EXISTS settings;');
