...
CREATE TABLE `designBlocks` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `parentId` int(11) unsigned DEFAULT NULL,
  `marginParentId` int(11) unsigned DEFAULT NULL,
  ...
  `paddingParentId` int(11) unsigned DEFAULT NULL,
  ...
  `backgroundParentId` int(11) unsigned DEFAULT NULL,
  ...
  `borderParentId` int(11) unsigned DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `designBlocks_parentId_fk` (`parentId`),
  KEY `designBlocks_marginParentId_fk` (`marginParentId`),
  KEY `designBlocks_paddingParentId_fk` (`paddingParentId`),
  KEY `designBlocks_backgroundParentId_fk` (`backgroundParentId`),
  KEY `designBlocks_borderParentId_fk` (`borderParentId`),
  CONSTRAINT `designBlocks_backgroundParentId_fk` FOREIGN KEY (`backgroundParentId`) REFERENCES `designBlocks` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `designBlocks_borderParentId_fk` FOREIGN KEY (`borderParentId`) REFERENCES `designBlocks` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `designBlocks_marginParentId_fk` FOREIGN KEY (`marginParentId`) REFERENCES `designBlocks` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `designBlocks_paddingParentId_fk` FOREIGN KEY (`paddingParentId`) REFERENCES `designBlocks` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `designBlocks_parentId_fk` FOREIGN KEY (`parentId`) REFERENCES `designBlocks` (`id`) ON DELETE SET NULL ON UPDATE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `designTexts` (
  ...
  PRIMARY KEY (`id`),
  KEY `designTexts_parentId_fk` (`parentId`),
  CONSTRAINT `designTexts_parentId_fk` FOREIGN KEY (`parentId`) REFERENCES `designTexts` (`id`) ON DELETE SET NULL ON UPDATE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-08-15 22:26:00
